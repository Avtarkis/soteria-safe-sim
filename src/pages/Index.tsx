        ...
        <div className="container mx-auto px-4 py-8 flex-1 flex flex-col items-center justify-center">
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              <h1 className="text-3xl font-extrabold text-center text-white">Soteria</h1>
              <p className="text-lg text-center text-gray-300 mt-2">...every second counts.</p>
              <p className="text-sm text-center text-gray-400 mt-2 mb-6">
